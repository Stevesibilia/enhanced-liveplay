...
## Purpose
Keep the GM-facing UI calm during storytelling: emphasis is reserved for live state, chrome stays quiet, and visual redesigns go through mockup approval before touching application code.
## Requirements
